...
// custom values
static const CGFloat CSToastBottomPadding = 45;


// general appearance
static const CGFloat CSToastMaxWidth            = 0.8;      // 80% of parent view width
static const CGFloat CSToastMaxHeight           = 0.8;      // 80% of parent view height
static const CGFloat CSToastHorizontalPadding   = 14.0;
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration {
    ...
    [self showToast:toast duration:duration position:CSToastDefaultPosition];
}
...
- (void)makeToastActivity:(id)position {
    ...
    activityView.backgroundColor = [[Util colorWithHexString:@"444444"] colorWithAlphaComponent:CSToastOpacity];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[Util colorWithHexString:@"444444"] colorWithAlphaComponent:CSToastOpacity];
